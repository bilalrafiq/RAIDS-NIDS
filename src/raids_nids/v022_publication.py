...
EVIDENCE_DIRECTORY = "v022_unsw_exploits_gate4"
...
EXPECTED_SOURCE_GIT_HEAD = "c0160d3ca9b35d80b6e0e7731fa9185ccd0cbcab"
EXPECTED_REQUIRED_BASE_COMMIT = "f58ff5ba45b999421fb9b5d46b14c97624338beb"
EXPECTED_OMITTED_MODEL_FILES = 100
EXPECTED_OMITTED_LOG_FILES = 6

EXPECTED_SEEDS = [11, 23, 37, 53, 71, 83, 97, 109, 127, 149]
EXPECTED_GATE4_METHODS = [
    "unsw_exploits_random_anchored_B050",
    "unsw_exploits_random_anchored_B200",
    "unsw_exploits_random_replay_B050",
    "unsw_exploits_random_replay_B200",
    "unsw_exploits_static",
    "unsw_exploits_ud_anchored_B050",
    "unsw_exploits_ud_anchored_B200",
    "unsw_exploits_ud_replay_B050",
    "unsw_exploits_ud_replay_B200",
]
...
def validate_query_provenance_audit(root: Path) -> None:
    audit = read_json(root / "audit" / "postrun_query_provenance_audit.json")
    expected_scalars = {
        "status": "passed",
...
def package_readme(manifest: dict[str, Any], archive: dict[str, Any]) -> str:
    return f"""# NF-UNSW-NB15-v3 Exploits v0.22 compact evidence

This directory is the public, path-safe representation of the completed v0.22
Gate 4 extension. The source evidence passed its internal checksum manifest,
...
```text
python scripts/verify_v022_publication_evidence.py --root results/frozen/v022_unsw_exploits_gate4
```
