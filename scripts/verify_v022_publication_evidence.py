...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Verify the compact v0.22 public evidence package."
    )
    ...
    try:
        ...
        print(f"v0.22 public evidence verification: FAILED\n{error}")
        return 1

    print("v0.22 public evidence verification: PASSED")
